function loadEmployeeInfo() {
  $.ajax({
    ...
    success: function (res) {
      ...
      // Select the container element where the cards will be appended
      const personnelCard = $("#personnelCard");

      // Initialize the string that will hold the HTML markup for all employee cards
      let employeeInfo = "";

      // Loop through the response data and create a card for each employee
      for (let i = 0; i < res.data.length; i++) {
        ...
        // Create the HTML markup for the card and append it to the string
        employeeInfo += `<div class="card mb-3" style="max-width: 450px">
            <div class="row g-0">
              <div class="col-md-4">
                <img
      ...
      // Append the string containing all employee card markup to the container element
